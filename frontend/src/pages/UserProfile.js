                ...
                <Box className="flex flex-col md:flex-row items-center md:items-start gap-6">
                  ...
                  <Box className="flex-1 text-center md:text-left">
                    ...
                    <Box className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                      {/* Conditionally render batch info */}
                      {user?.batch && (
                        <InfoCard icon={GraduationCap} title="Batch" value={user.batch.name} />
                      )}
                      <InfoCard icon={User} title="Student ID" value={user?.user?.enrollment_number} />
                      <InfoCard
                        icon={Calendar}
                        title="Joined"
            ...
            <ProfileCard>
              <CardContent className="p-6">
                <Box className="flex items-center justify-between mb-6">
                  <GradientTypography variant="h5">Enrolled Courses</GradientTypography>
                  <Chip
